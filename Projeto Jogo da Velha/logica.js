...
//alert("REGRAS DO JOGO:\n 1-O X SEMPRE COMECA;\n 2- O BOTAO RESET PODE SER USADO A QLQ MOMENTO;\n 3-CASO O JOGO EMPATE SERA RESETADO AUTOMATICAMENTE;\n 4- CLICK NO OK E COMECE A DIVERSAO :D;\n\n OBS: NAO TEM ACENTOS NEM CDILHA PQ INTERPERTA BUGADO. ,-,");
...
function inicializarEspacos(){
	...
	for (var i = 0; i < espacos.length; i++) {
		...
		espacos[i].addEventListener("click", async function(){
			...
			if(this.getAttribute("jogada") == ""){
				...
				if(contJogada >=9){
					...
					alert("O JOGO EMPATOU E SERA REINICIADO ^^");
					reset();
